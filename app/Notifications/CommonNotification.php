    ...
    public function via($notifiable)
    {
        ...
        if ($notifiable->player_id != null) {
            if ($notifiable->user_type == 'driver' && env('ONESIGNAL_DRIVER_APP_ID') && env('ONESIGNAL_DRIVER_REST_API_KEY')) {
                ...
                // $channelId = env('ONESIGNAL_DRIVER_CHANNEL_ID');
                $heading = [
                    'en' => $this->subject,
                ];
                ...
                $parameters = [
                    ...
                    'ios_sound' => $sound,
                    // ✅ AGREGAR: Parámetros críticos para iOS
                    'ios_badgeType' => 'Increase',
                    'ios_badgeCount' => 1,
                    'mutable_content' => true,
                    'content_available' => true,
                    'apns_env' => 'sandbox', // Cambiar a 'sandbox' para desarrollo
                ...
                $parameters = [
                    ...
                    // ✅ AÑADIR: Configuración crítica para iOS Riders
                    'ios_badgeType' => 'Increase',
                    'ios_badgeCount' => 1,
                    'mutable_content' => true,
                    'content_available' => true,
                    'apns_env' => 'sandbox', // ← AÑADIR ESTA LÍNEA CRÍTICA
